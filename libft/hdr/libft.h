...
** str_replace
** lstinsert
** lstpop with pointers ? and rename current into lstpopi ?
...
/*
** Returns the amount of elements in the given list 'lst'. Checks for a loop to
** the beginning and returns only the number of distinct elements.
*/
